...
import com.example.jsf.service.SismosService;
import com.example.jsf.domain.DominioCount;
import com.example.jsf.domain.DominioFeatures;
import com.example.jsf.domain.DominioGeometry;
import com.example.jsf.domain.DominioProperties;
...
public class BeanSismos implements Serializable {
    @Autowired
    private SismosService serviceSismos;
     ...
     */
    public SismosService getServiceSismos() {
     ...
     */
    public void setServiceSismos(SismosService serviceSismos) {
